...
namespace LiveMedy.Services
{
    public class MailServisi
    {
        ...
        private static void MailYolla(string gonderenMailAdresi, string gonderenMailinGosterilenAdi, string gonderilecekAdres, string konu, string icerik, string mailSunucusu, string kullaniciAdi, string sifre)
        {
        ...
        public static LiveMedyContext db = new LiveMedyContext();
