 ...
 * }
 */
var validateSkeletonFieldsPosMap = "GyYuUrQqMLlwWEecdDFghHUnbmsSAzZOvVXx".split( "" ).reduce(function( memo, item, i ) {
	memo[ item ] = i;
	return memo;
}, {});
...
var validateSkeleton = function validateSkeleton( skeleton ) {
	...
	skeleton.replace( /[^GyYuUrQqMLlwWEecdDFghHUnbmsSAzZOvVXx]/, function( field ) {
		throw createError(
...
var dateExpandPattern = function( options, cldr ) {
	...
	switch ( true ) {
		case "skeleton" in options:
			...
			timeSkeleton = skeleton.split( /[^hHUnbmsSAzZOvVXx]/ ).slice( -1 )[ 0 ];
